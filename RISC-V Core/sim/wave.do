...
add wave -noupdate -expand -group UUT -radix hexadecimal /core_top_tb/uut/instruction_addr
add wave -noupdate -expand -group UUT -radix hexadecimal /core_top_tb/uut/next_addr
add wave -noupdate -expand -group UUT -radix hexadecimal /core_top_tb/uut/instruction_addr_trimmed
add wave -noupdate -expand -group UUT -radix hexadecimal /core_top_tb/uut/next_addr_trimmed
add wave -noupdate -expand -group UUT -radix hexadecimal /core_top_tb/uut/instruction
add wave -noupdate -expand -group UUT -radix hexadecimal /core_top_tb/uut/alu_in
add wave -noupdate -expand -group UUT -radix hexadecimal /core_top_tb/uut/branch_addr
add wave -noupdate -expand -group UUT -radix hexadecimal /core_top_tb/uut/inc_addr
add wave -noupdate -expand -group UUT -radix hexadecimal /core_top_tb/uut/Result
...
add wave -noupdate -expand -group UUT -radix hexadecimal /core_top_tb/uut/reg_data1
...
add wave -noupdate -expand -group UUT -radix hexadecimal /core_top_tb/uut/ALUCtl
add wave -noupdate -expand -group UUT -radix hexadecimal /core_top_tb/uut/MemRead
add wave -noupdate -expand -group UUT -radix hexadecimal /core_top_tb/uut/MemWrite
add wave -noupdate -expand -group UUT -radix hexadecimal /core_top_tb/uut/MemtoReg
add wave -noupdate -expand -group UUT -radix hexadecimal /core_top_tb/uut/Branch
add wave -noupdate -expand -group UUT -radix hexadecimal /core_top_tb/uut/ALUSrc
add wave -noupdate -expand -group UUT -radix hexadecimal /core_top_tb/uut/RegWrite
add wave -noupdate -expand -group UUT -radix hexadecimal /core_top_tb/uut/Zero
add wave -noupdate -expand -group UUT -radix hexadecimal /core_top_tb/uut/ALUOp
